...
public aspect FileInputStreamTracker {
  ...
  public final class Delegate extends FileInputStream {
    public Delegate(File file) throws FileNotFoundException { super(file); }
    public Delegate(String path) throws FileNotFoundException { super(path); }
    public Delegate(FileDescriptor fd) { super(fd); }
